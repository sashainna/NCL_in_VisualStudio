/***********************************************************************
**
**   FILE NAME: PostcompView.cpp
**
**   CONTAINS:
**		CPostcompView::CPWorksView()
**		CPostcompView::~CPWorksView()
**		 CPostcompView::PreCreateWindow()
**		CPostcompView::OnInitialUpdate()
**		CPostcompView::OnCtlColor()
**		CPostcompView::OnFileExit() 
**		CPostcompView::OnFileOpen()
**		CPostcompView::OnOptionOptions()
**		CPostcompView::OnPostcompRun() 
**
**    COPYRIGHT 2002 (c) Numerical Control Computer Sciences.
**          All Rights Reserved
**     MODULE NAME AND RELEASE LEVEL
**			postcompView.cpp , 24.2
...
IMPLEMENT_DYNCREATE(CPostcompView, CFormView)

BEGIN_MESSAGE_MAP(CPostcompView, CFormView)
	//{{AFX_MSG_MAP(CPostcompView)
		ON_WM_CTLCOLOR()
		...
		ON_BN_CLICKED(ID_POSTCOMP_RUN, OnPostcompRun)
		ON_WM_DROPFILES()
...
/////////////////////////////////////////////////////////////////////////////
// CPostcompView construction/destruction

/***********************************************************************
c
c   SUBROUTINE: CPostcompView()	
c
...
c***********************************************************************
*/
CPostcompView::CPostcompView()
	: CFormView(CPostcompView::IDD)
{
	//{{AFX_DATA_INIT(CPostcompView)
...
void CPostcompView::DoDataExchange(CDataExchange* pDX)
{
	CFormView::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPostcompView)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}

BOOL CPostcompView::PreCreateWindow(CREATESTRUCT& cs)
{
...
c***********************************************************************
*/
void CPostcompView::OnInitialUpdate()
{
	...
	Pw_maindlg = this;
	GetDlgItem(IDC_POSTCOMP_NAME)->SetFocus();
...
//			strcat(fnames, "\\");
	...
	GetDlgItem(IDC_POSTCOMP_NAME)->SetWindowText(FileName);
	delete filedlg;	
}
...
c***********************************************************************
*/
void CPostcompView::OnOptionOptions() 
{
	PCompOptDlg dlgopt;
	dlgopt.DoModal();
}
...
c***********************************************************************
*/
void CPostcompView::OnPostcompRun() 
{
	int i;
	...
	GetDlgItem(IDC_POSTCOMP_NAME)->GetWindowText(fnames, 79999);
/*
...
c***********************************************************************
*/
HBRUSH CPostcompView::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
c***********************************************************************
*/
void CPostcompView::OnHelpAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
...
c***********************************************************************
*/
void CPostcompView::OnHelpContents()
{
...
**
**********************************************************************/
void CPostcompView::OnDropFiles(HDROP hDropInfo)
{
	CString FileName = "";
    UINT i,j,knc;
...
/////////////////////////////////////////////////////////////////////////////
// CPostcompView diagnostics

#ifdef _DEBUG
void CPostcompView::AssertValid() const
{
	CFormView::AssertValid();
}

void CPostcompView::Dump(CDumpContext& dc) const
{
	CFormView::Dump(dc);
}

CPostworksDoc* CPostcompView::GetDocument() // non-debug version is inline
{
...
/////////////////////////////////////////////////////////////////////////////
// CPostcompView message handlers
