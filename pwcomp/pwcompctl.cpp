...
BEGIN_MESSAGE_MAP(CPostcompApp, CWinApp)
	//{{AFX_MSG_MAP(CPostcompApp)
...
/////////////////////////////////////////////////////////////////////////////
// CPostcompApp construction

CPostcompApp::CPostcompApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CPostcompApp object

CPostcompApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CPostcompApp initialization
...
c***********************************************************************
*/
BOOL CPostcompApp::InitInstance()
{
...
.....Open log file
*/
			PW_logfile = fopen("postcomp.log", "a+");
			if (ierr!=0)
				cerrkil (msg,&ierr);
			else
				postcomp();
