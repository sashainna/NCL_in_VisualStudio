...
#define FEEDRATECHC1	27
#define FEEDRATERG1		28
#define FEEDRATECHC2	29
#define FEEDRATERG2		30
#define FEEDRATECHC3	31
#define FEEDRATERG3		32
...
.....Feed Rates
*/
		&Tfopt[0],(int *)&Tfeed[0],&Tfopt[1],(int *)&Tfeed[1],
		&Tfopt[2],(int *)&Tfeed[2],
/*
.....Thick
*/
...
*/
	...
	static UD_METHOD methods[] = {
		...
		OnFdTog,OnFeedTxt,OnFdTog,OnFeedTxt,OnFdTog,OnFeedTxt,
...
*/
		...
		cbuf[0] = cbuf[0] / 2.;
		ncl_sprintf(Smdis,&cbuf[0],1);
/*ken should be 1		Sclrtyp = 0;
		Sclr[0] = '\0';
*/
		Sclrtyp = 1;
		strcpy(Sclr,"0.");
		...
		for (i=0;i<3;i++) strcpy(Sfeed[i],"0.");
	}
	else
	{
		ncl_get_scalar_value(Smdis,&rval);
		if (rval <= 0.)
		{
			cutget(cbuf,dbuf,iclf,sym,sym,sym);
			cbuf[0] = cbuf[0] / 2.;
