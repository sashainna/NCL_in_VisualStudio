...
#define  UM_NE_UVCVONSF 25 /* number of curve on surface relations */
...
#define  UM_NE_STAT 1	/* number of statistics entries */
...
#define  UM_NV_POINT    1    /* number of point variable lists */
#define  UM_NV_LINE     1    /* number of line variable lists */
#define  UM_NV_CIRCLE   1    /* number of circle variable lists */
#define  UM_NV_CONIC    1    /* number of conic variable lists */
#define  UM_NV_COMPCRV  2    /* number of composite curve variable lists */
#define  UM_NV_BSPLCRV  2    /* number of bspline curve variable lists */
#define  UM_NV_RBSPLCRV 4    /* number of rational bspline curve variable */
							  	 	  /* lists */
#define  UM_NV_UVCVONSF 4    /* number of curve on surface variable lists */
#define	UM_NV_POLY     1    /* number of filled polygon vlists	*/
#define	UM_NV_POLYLINE	2		/* number of polyline vlists	*/
...
#define  UM_NV_RBSPLSRF 6    /* number of rational bspline surface */
								 	  /* variable lists */
...
#define  UM_NV_TEXT     2    /* number of text variable lists */
...
#define	UM_NV_LAYER		1		/* number of layer var lists */
#define  US_NV_SYMBOL   3		/* number of symbol var lists */
#define  UM_NV_STAT		1		/* number of statistics var lists */
#define UM_INITREL
#endif
