...
c
      ...
      !integer*2 keytcv,lpos,isv2(2),iept(2),mupt,ierr,nclkey
      integer*2 keytcv,lpos,isv2(2),iept(2),mupt,ierr

      integer*2 isv104,mod,numpts,lnk,kdntcu,isubcl,iflat,knttcv,jptk
      !integer*2 isv104,mod,lnk,kdntcu,isubcl,iflat,knttcv,jptk
      integer*4 nclkey
