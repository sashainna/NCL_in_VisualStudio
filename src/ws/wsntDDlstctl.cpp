...
#if UU_COMP == UU_WIN2K
/************************************************************************
**		FILE NAME: CNCLDDListCtrl.cpp
**
**	 Description - Functions and implementations for
**		CNCLDDListCtrl class (NCL table list)
**		with Drag&Drop
**	 CONTAINS:
**		member function of CNCLDDListCtrl
**
**    COPYRIGHT 2013 (c) NCCS.  All Rights Reserved.
**    MODULE NAME AND RELEASE LEVEL 
**			wsntDDlstctl.cpp , 25.3
...
/***********************************************************************
**   FUNCTION: CNCLDDListCtrl
**		Constructor of class CNCLDDListCtrl
**
**   INPUT:  none
**
**   OUTPUT :   None
...
**
**   FUNCTION: ~CNCLDDListCtrl
**              Destructor of class CNCLDDListCtrl, free space.
**
**   INPUT:  None
**
**   OUTPUT :   None
...
BEGIN_MESSAGE_MAP(CNCLDDListCtrl, CListCtrl)
	//{{AFX_MSG_MAP(CNCLDDListCtrl)
	ON_WM_NCCALCSIZE()
	ON_WM_LBUTTONDOWN()
	ON_WM_LBUTTONUP()
	ON_WM_RBUTTONUP()
...
**
**********************************************************************/
int CNCLDDListCtrl::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
/////////////////////////////////////////////////////////////////////////////
// CNCLDDListCtrl message handlers

//****************************************************************************************

void CNCLDDListCtrl::OnNcCalcSize(BOOL bCalcValidRects, NCCALCSIZE_PARAMS FAR* lpncsp) 
{
...
c
**********************************************************************/
void CNCLDDListCtrl::OnLButtonDown(UINT nFlags, CPoint point) 
{
...
c
**********************************************************************/
void CNCLDDListCtrl::OnLButtonUp(UINT nFlags, CPoint point) 
{
...
c
**********************************************************************/
void CNCLDDListCtrl::OnRButtonUp(UINT nFlags, CPoint point) 
{
	if (m_parent==NULL)
		return;
	CListCtrl::OnRButtonUp(nFlags, point);
}
void CNCLDDListCtrl::SetProperty(CNCLFormProp *prop_dlg)
{
	RECT rectClient;
...
**
**********************************************************************/
void CNCLDDListCtrl::OnSize(UINT nType, int cx, int cy) 
{
...
**
**********************************************************************/
void CNCLDDListCtrl::OnMove(int x, int y)
{
...
c
**********************************************************************/
void CNCLDDListCtrl::OnMouseMove(UINT nFlags, CPoint point) 
{
...
**
**********************************************************************/
void CNCLDDListCtrl::OnTimer(UINT_PTR nIDEvent) 
{	
/*	
...
**
**********************************************************************/
void CNCLDDListCtrl::OnDragDropCallback(CPoint pt, char *input_text)
{
...
c
**********************************************************************/
BOOL CNCLDDListCtrl::PreTranslateMessage(MSG* pMsg) 
{
	int stat = 0;
	HWND hWnd = (HWND)*this; 
...
*/
					...
					if (pos!=NULL)
						answer = GetNextSelectedItem(pos);
					else
						answer = -1;

					ClientToScreen(&point);
					sprintf(tempstr, "%d %d %d %d", m_itemno, point.x, point.y, answer);
					itext2 = tempstr;
					iText = "Move CNCLDDListCtrl " + itext2;
...
c
**********************************************************************/
void CNCLDDListCtrl::SetActive(int active)
{
...
c
**********************************************************************/
void CNCLDDListCtrl::DrawGuides(CPoint org_pt, POINT ptCursor)
{
...
**
**********************************************************************/
void CNCLDDListCtrl::SetItemNo(int itemno)
{
	m_itemno = itemno;
	if (m_prop_dlg==NULL)
	{
...
**
**********************************************************************/
void CNCLDDListCtrl::set_prop_values(double font_scale, int active, char *color, char *pcolor)
{
...
void CNCLDDListCtrl::set_prop_HSPvalues(int n_picarea, UD_PICAREA *picarea)
{
	int k;
...
IMPLEMENT_DYNAMIC(CNCLDDListCtrl, CListCtrl)
