...
#if UU_COMP == UU_WIN2K
/************************************************************************
**		FILE NAME: CNCLDDListCtrl2.cpp
**
**	 Description - Functions and implementations for
**		CNCLDDListCtrl2 class (NCL list control for DATA)
**		with Drag&Drop
**	 CONTAINS:
**		member function of CNCLDDListCtrl2
**
**    COPYRIGHT 2013 (c) NCCS.  All Rights Reserved.
**    MODULE NAME AND RELEASE LEVEL 
**			wsntDDlstctl2.cpp , 25.3
...
/***********************************************************************
**   FUNCTION: CNCLDDListCtrl2
**		Constructor of class CNCLDDListCtrl2
**
**   INPUT:  none
**
**   OUTPUT :   None
...
**
**********************************************************************/
CNCLDDListCtrl2::CNCLDDListCtrl2()
	:	m_TargetDrop(NULL),
		m_TimerID(0)
{
...
**
**   FUNCTION: ~CNCLDDListCtrl2
**              Destructor of class CNCLDDListCtrl2, free space.
**
**   INPUT:  None
**
**   OUTPUT :   None
...
BEGIN_MESSAGE_MAP(CNCLDDListCtrl2, CListCtrl)
	//{{AFX_MSG_MAP(CNCLDDListCtrl2)
	ON_WM_NCCALCSIZE()
...
**
**********************************************************************/
int CNCLDDListCtrl2::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
/////////////////////////////////////////////////////////////////////////////
// CNCLDDListCtrl2 message handlers

//****************************************************************************************

void CNCLDDListCtrl2::OnNcCalcSize(BOOL bCalcValidRects, NCCALCSIZE_PARAMS FAR* lpncsp) 
{
...
**    WARNINGS     : none
*********************************************************************/
void CNCLDDListCtrl2::OnCustomDraw(NMHDR *pNMHDR, LRESULT *pResult)
{
...
**    WARNINGS     : none
*********************************************************************/
void CNCLDDListCtrl2::OnClick(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
**    WARNINGS     : none
*********************************************************************/
void CNCLDDListCtrl2::SetItemSel(int row, int col)
{
	invalidate_grid(m_sel_row,m_sel_col);
	m_sel_row = row;
	m_sel_col = col;
...
**    WARNINGS     : none
*********************************************************************/
void CNCLDDListCtrl2::GetSelectedItem(int *row, int *col)
{
	*row = m_sel_row;
	*col = m_sel_col;
}
...
**    WARNINGS     : none
*********************************************************************/
void CNCLDDListCtrl2::fill_item_data(int row, UD_ITEMDATA *data)
{
	int i,j,len,col;
	CString str;
...
**    WARNINGS     : none
*********************************************************************/
void CNCLDDListCtrl2::OnKeydown(NMHDR* pNMHDR, LRESULT* pResult) 
{
	int next;
	UD_ITEMDATA *data;
...
**    WARNINGS     : none
*********************************************************************/
void CNCLDDListCtrl2::invalidate_grid(int row, int col)
{
	CRect r;
...
**
**********************************************************************/
void CNCLDDListCtrl2::OnDestroy() 
{
	if(m_TargetDrop)
	{
		m_TargetDrop->Revoke();
...
c
**********************************************************************/
void CNCLDDListCtrl2::OnLButtonDown(UINT nFlags, CPoint point) 
{
...
c
**********************************************************************/
void CNCLDDListCtrl2::OnLButtonUp(UINT nFlags, CPoint point) 
{
...
c
**********************************************************************/
void CNCLDDListCtrl2::OnRButtonUp(UINT nFlags, CPoint point) 
{
	if (m_parent==NULL)
		return;
...
void CNCLDDListCtrl2::SetProperty(CNCLFormProp *prop_dlg)
{
	RECT rectClient;
...
**
**********************************************************************/
void CNCLDDListCtrl2::OnSize(UINT nType, int cx, int cy) 
{
...
**
**********************************************************************/
void CNCLDDListCtrl2::OnMove(int x, int y)
{
...
c
**********************************************************************/
void CNCLDDListCtrl2::OnMouseMove(UINT nFlags, CPoint point) 
{
...
**
**********************************************************************/
void CNCLDDListCtrl2::OnTimer(UINT_PTR nIDEvent) 
{	
/*	
...
**
**********************************************************************/
void CNCLDDListCtrl2::OnDragDropCallback(CPoint pt, char *input_text)
{
...
c
**********************************************************************/
BOOL CNCLDDListCtrl2::PreTranslateMessage(MSG* pMsg) 
{
	int stat = 0;
	HWND hWnd = (HWND)*this; 
...
*/
		...
		((CNCLDDform*)m_parent)->HandleButtonDown(pMsg->wParam, point);
	}
...
*/
		CPoint point = pMsg->pt;
		((CNCLDDform*)m_parent)->ScreenToClient(&point);
		((CNCLDDform*)m_parent)->HandleButtonup(pMsg->wParam, point);
	}
...
*/
					...
					CString itext2;
					int answer[2];
					GetSelectedItem(&(answer[0]), &(answer[1]));

					ClientToScreen(&point);
					sprintf(tempstr, "%d %d %d %d %d", m_itemno, point.x, point.y, answer[0], answer[1]);
					itext2 = tempstr;
					iText = "Move CNCLDDListCtrl2 " + itext2;
...
c
**********************************************************************/
void CNCLDDListCtrl2::SetActive(int active)
{
...
c
**********************************************************************/
void CNCLDDListCtrl2::DrawGuides(CPoint org_pt, POINT ptCursor)
{
...
**
**********************************************************************/
void CNCLDDListCtrl2::SetItemNo(int itemno)
{
	m_itemno = itemno;
	if (m_prop_dlg==NULL)
	{
...
**
**********************************************************************/
void CNCLDDListCtrl2::set_prop_values(double font_scale, int active, char *color, char *pcolor)
{
...
void CNCLDDListCtrl2::set_prop_HSPvalues(int n_picarea, UD_PICAREA *picarea)
{
	int k;
...
IMPLEMENT_DYNAMIC(CNCLDDListCtrl2, CListCtrl)
