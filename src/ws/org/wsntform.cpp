...
//do not use UW_form_fontsize because all size in this function pass
//in inittemp is a unit size, it should be fixed, not adjust by font size
//		uw_ntget_strsize(m_dsplabel[i], UW_form_fontsize*10, UW_formdlg_font, &wid, &hgt);
...
//do not use UW_form_fontsize because all size in this function pass
//in inittemp is a unit size, it should be fixed, not adjust by font size
//				uw_ntget_strsize(m_fldlabel[i], UW_form_fontsize*10, UW_formdlg_font, &pwid, &phgt);
			else
			{
/*
.....we will use phgt
...
//do not use UW_form_fontsize because all size in this function pass
//in inittemp is a unit size, it should be fixed, not adjust by font size
//					uw_ntget_strsize(perc_str, UW_form_fontsize*10, UW_formdlg_font, &pwid2, &phgt);
					m_rgDlgItem[m_itemnum++].Inittemp("", m_type[i], 
