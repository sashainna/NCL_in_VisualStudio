...
**		This version make all reals "float"
**       CONTAINS:
...
#define UU_SYSDEF
#define UU_FLTDEF
#define UU_KEY_ID unsigned long
#define UU_REL_ID unsigned long
