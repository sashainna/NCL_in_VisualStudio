...
/********************************************************************* 
**  NAME:  ws410x.h
**      Include file for GKS workstation for Tek 41xx (ws410x.c)
**	 CONTAINS:
**
...
#define TMPSEG 726				/* tmp seg for 41xxopnseg */
#define DRAGSEG 727				/* start of 10 locator dragging segments */
#define EMPTYSEG 737				/* an empty seg, for 41xxtrk, 41xxpik */
...
#define EOMCHAR2 10
#define EOLCHAR 10
/* if UU_DEBUG, ws410xc.c will compile. Otherwise include ws410xc.h */
#ifdef UU_DEBUGOFF
#include "ws410xc.h"
#endif
