/***********************************************************************
**
**   FILE NAME: GenwordView.cpp
**
**   CONTAINS:
**		CGenwordView::CGenwordView()
**		CGenwordView::~CGenwordView()
**		CGenwordView::PreCreateWindow()
**		CGenwordView::OnInitialUpdate()
**		CGenwordView::OnCtlColor()
**		CGenwordView::OnFileExit() 
**		CGenwordView::OnFileOpen()
**		CGenwordView::OnOptionOptions()
**		CGenwordView::OnPworksRun() 
**
**    COPYRIGHT 2002 (c) Numerical Control Computer Sciences.
**          All Rights Reserved
**     MODULE NAME AND RELEASE LEVEL
**			genwordView.cpp , 24.2
...
IMPLEMENT_DYNCREATE(CGenwordView, CFormView)

BEGIN_MESSAGE_MAP(CGenwordView, CFormView)
	//{{AFX_MSG_MAP(CGenwordView)
		...
		ON_BN_CLICKED(ID_GENWORD_RUN, OnGenwordRun)
		ON_WM_DROPFILES()
...
/////////////////////////////////////////////////////////////////////////////
// CGenwordView construction/destruction

/***********************************************************************
c
c   SUBROUTINE: CGenwordView()	
c
...
*/
CGenwordView::CGenwordView()
	: CFormView(CGenwordView::IDD)
{
	//{{AFX_DATA_INIT(CGenwordView)
...
void CGenwordView::DoDataExchange(CDataExchange* pDX)
{
	CFormView::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CGenwordView)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}

BOOL CGenwordView::PreCreateWindow(CREATESTRUCT& cs)
{
...
c***********************************************************************
*/
void CGenwordView::OnInitialUpdate()
{
	...
	Pw_maindlg = this; 
	GetDlgItem(IDC_GENWORD_NAME)->SetFocus();
...
void CGenwordView::OnFileOpen() 
{
	...
	files[0] = '\0';
	CFileDialog *filedlg = new CFileDialog(TRUE, "GenWord", NULL, dwFlags,
			filter, this);
...
//			strcat(fnames, "\\");
	...
	GetDlgItem(IDC_GENWORD_NAME)->SetWindowText(FileName);
	delete filedlg;	
}

/***********************************************************************
c
c   SUBROUTINE:  OnGenwordRun
c
...
c***********************************************************************
*/
void CGenwordView::OnGenwordRun() 
{
	int i;
	char *indx, fnames[10000], filename[UX_MAX_PATH];
	...
	GetDlgItem(IDC_GENWORD_NAME)->GetWindowText(fnames, 7999);
/*
...
c***********************************************************************
*/
HBRUSH CGenwordView::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
c***********************************************************************
*/
void CGenwordView::OnHelpContents()
{
...
**
**********************************************************************/
void CGenwordView::OnDropFiles(HDROP hDropInfo)
{
	CString FileName = "";
    UINT i,j,knc;
...
/////////////////////////////////////////////////////////////////////////////
// CGenwordView diagnostics

#ifdef _DEBUG
void CGenwordView::AssertValid() const
{
	CFormView::AssertValid();
}

void CGenwordView::Dump(CDumpContext& dc) const
{
	CFormView::Dump(dc);
}

CPostworksDoc* CGenwordView::GetDocument() // non-debug version is inline
{
