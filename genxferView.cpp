/***********************************************************************
**
**   FILE NAME: GenxferView.cpp
**
**   CONTAINS:
**		CGenxferView::CGenxferView()
**		CGenxferView::~CGenxferView()
**		CGenxferView::PreCreateWindow()
**		CGenxferView::OnInitialUpdate()
**		CGenxferView::OnCtlColor()
**		CGenxferView::OnFileExit() 
**		CGenxferView::OnFileOpen()
**		CGenxferView::OnOptionOptions()
**		CGenxferView::OnPworksRun() 
**
**    COPYRIGHT 2002 (c) Numerical Control Computer Sciences.
**          All Rights Reserved
**     MODULE NAME AND RELEASE LEVEL
**			genxferView.cpp , 24.2
...
IMPLEMENT_DYNCREATE(CGenxferView, CFormView)

BEGIN_MESSAGE_MAP(CGenxferView, CFormView)
	//{{AFX_MSG_MAP(CGenxferView)
		...
		ON_BN_CLICKED(ID_GENXFER_RUN, OnGenxferRun)
		ON_WM_DROPFILES()
...
/////////////////////////////////////////////////////////////////////////////
// CGenxferView construction/destruction

/***********************************************************************
c
c   SUBROUTINE: CGenxferView()	
c
...
*/
CGenxferView::CGenxferView()
	: CFormView(CGenxferView::IDD)
{
	//{{AFX_DATA_INIT(CGenxferView)
...
void CGenxferView::DoDataExchange(CDataExchange* pDX)
{
	CFormView::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CGenxferView)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}

BOOL CGenxferView::PreCreateWindow(CREATESTRUCT& cs)
{
...
c***********************************************************************
*/
void CGenxferView::OnInitialUpdate()
{
	...
	Pw_maindlg = this; 
	GetDlgItem(IDC_GENXFER_NAME)->SetFocus();
...
//			strcat(fnames, "\\");
	...
	GetDlgItem(IDC_GENXFER_NAME)->SetWindowText(FileName);
	delete filedlg;	
}

/***********************************************************************
c
c   SUBROUTINE:  OnGenxferRun
c
...
c***********************************************************************
*/
void CGenxferView::OnGenxferRun() 
{
	int i;
	...
	GetDlgItem(IDC_GENXFER_NAME)->GetWindowText(fnames, 7999);
/*
...
*/
/* 
.....remove here, we will do it later, if added here,
.....it will hit memory error because it will have more chars
.....as define because of strcat function
*/
//		for (i=strlen(filename); i<UX_MAX_PATH;i++)
//			filename[i] = ' ';
/*
...
c***********************************************************************
*/
HBRUSH CGenxferView::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
c***********************************************************************
*/
void CGenxferView::OnHelpContents()
{
...
**
**********************************************************************/
void CGenxferView::OnDropFiles(HDROP hDropInfo)
{
	CString FileName = "";
    UINT i,j,knc;
...
/////////////////////////////////////////////////////////////////////////////
// CGenxferView diagnostics

#ifdef _DEBUG
void CGenxferView::AssertValid() const
{
	CFormView::AssertValid();
}

void CGenxferView::Dump(CDumpContext& dc) const
{
	CFormView::Dump(dc);
}

CPostworksDoc* CGenxferView::GetDocument() // non-debug version is inline
{
