/************************************************************************
c
c   FILE NAME: stepDlg2.cpp
c
c	 CONTAINS: 
c		Functions for the class CStepDlg2
c
...
c**********************************************************************
*/
// stepDlg2.cpp : implementation file
//
...
CStepDlg2::CStepDlg2(CWnd* pParent /*=NULL*/)
	: CDialog(CStepDlg2::IDD, pParent)
{
...
void CStepDlg2::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CStepDlg2)
	DDX_Control(pDX, IDC_PROGRESS1, m_pctl);
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CStepDlg2, CDialog)
	//{{AFX_MSG_MAP(CStepDlg2)
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
BOOL CStepDlg2::OnInitDialog()
{
	...
	double ver;
	getver(&ver);
	sprintf(verstr,"NCL/STEP V%5.3f",ver);
...
c
**********************************************************************/
HCURSOR CStepDlg2::OnQueryDragIcon()
{
...
c***********************************************************************
*/
void CStepDlg2::Display_as_percent(int num)
{
	MSG msg;
	int stat;
	char label[256];
...
c***********************************************************************
*/
void CStepDlg2::ShowProcessWindow(char *title)
{
	if (m_processor)
		return;
...
c***********************************************************************
*/
void CStepDlg2::CloseProcessWindow()
{
	m_processor = 0;
	m_curpos = 0;
...
c***********************************************************************
*/
void CStepDlg2::SetProcessLabel(char *label1, char *label2)
{
