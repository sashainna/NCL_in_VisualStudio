/************************************************************************
c
c   FILE NAME: StepPromptDlg.cpp
c
c	 CONTAINS: 
c		Functions for the class StepPromptDlg
c
c     COPYRIGHT 2013 (c) Numerical Control Computer Sciences.
c           All Rights Reserved
c      MODULE NAME AND RELEASE LEVEL
c       StepPromptDlg.cpp , 25.1
...
CStepPromptDlg::CStepPromptDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CStepPromptDlg::IDD, pParent)
{
	m_cols = 80;
	m_lns = 1;
	...
	m_msg = "Input Text: ";
	m_input = "";
	//{{AFX_DATA_INIT(CStepPromptDlg)
	//}}AFX_DATA_INIT
}


void CStepPromptDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CStepPromptDlg)
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CStepPromptDlg, CDialog)
	//{{AFX_MSG_MAP(CStepPromptDlg)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CStepPromptDlg message handlers
...
c
**********************************************************************/
BOOL CStepPromptDlg::OnInitDialog() 
{
...
**    WARNINGS     : none
*********************************************************************/
void CStepPromptDlg::SetDlgValue(int cols, int lns, char *title, char *msg, char*input)
{
	m_cols = cols;
	m_lns = lns;
	m_msg = msg;
...
**    WARNINGS     : none
*********************************************************************/
void CStepPromptDlg::GetInput(char *input, int maxnum)
{
	char *temp = m_input.GetBuffer(maxnum);
	strcpy (input, temp);
}

void CStepPromptDlg::OnOK() 
{
