...
**  NAME:  mslframe.cpp
**
**			Native WinNT main frame functions for MSLITE
...
HWND NCL_cmdwin  = NULL, NCL_statwin = NULL;
...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWnd)
	...
	ON_COMMAND_RANGE(WM_APP+UDM_MAX_MENU+UZ_MAX_KEYITEM, WM_APP+UDM_MAX_MENU+UZ_MAX_KEYITEM+NBUTTONNUM, OnMSLFunctions)
...
/***********************************************************************
**
**   FUNCTION: initial_msl
**
**		Doing the MSL related function for displayed in the main window
**   
**		INPUT:  none
**
**   OUTPUT :   none
...
*/
	...
	uw_ntwindow();
	CMsliteView * graphic_view = (CMsliteView *)NCL_CurrentPKT_View;
...
/*
......empty function just because we need it match all functions and data's
......for CMainFrame defined in wsntframe.h since there are may class will
......acess same class
*/
void CMainFrame::Ondummy1()
{
}

void CMainFrame::Ondummy2()
{
}
...
/**********************************************************************
**    I_FUNCTION :  OnMSLFunctions(UINT id)
...
**    WARNINGS     : none
*********************************************************************/
void CMainFrame::OnMSLFunctions(UINT id)
{
/*
......use local value
*/
...
/**********************************************************************
**    I_FUNCTION :  SetCommand_Str(char *cmdstr, int &line_num)
...
void CMainFrame::SetCommand_Str(CString cmdstr, int line_num, int upload)
{
	...
	CString label, text;
	int line;
	m_commandBar->getcmdtext(label, text, line, upload);
	m_commandBar->setcmdtext(label, cmdstr, line_num);
}
/**********************************************************************
...
**    PARAMETERS   
**       INPUT  : 
**          cmdcur: insert position to be set
**       OUTPUT :  
**          cmdstr:
**
**    RETURNS      : none
