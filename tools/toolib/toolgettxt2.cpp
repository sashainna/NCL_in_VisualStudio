...
BOOL CNCLGetText2::OnInitDialog()
{
	...
	int stat = m_txtfont.CreatePointFont (80, _T("MS Sans Serif"));
	SetFont(&m_txtfont);
	...
	{
		sizeText = dc.GetTextExtent(_T("l"), 1);
	}
	int wid1, wid2, hgt;
	wid1 = sizeText.cx;
	hgt = sizeText.cy;
