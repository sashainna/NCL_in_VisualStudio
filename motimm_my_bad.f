...
c                  tool(15-17)
c...Do not set those flag value, keep as it is. temp remove 1/28/19, Yurong
c      ifl(104)=0
c      ifl(293)=0
c...why rest this flag, temp remove 1/22/19, Yurong
c      lmdnow = .false.
      if (nw.eq.0) then
         goto 802
      endif 
...
c
c...only when modify value is valid value, set modify flag
c...changed Yurong
c
